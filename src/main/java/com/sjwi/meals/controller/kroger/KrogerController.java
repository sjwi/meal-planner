...
public class KrogerController {
  ...
  public ModelAndView searchProducts(
      @RequestParam String term, @RequestParam(defaultValue = "1") Integer pageCount)
      throws URISyntaxException, UnsupportedEncodingException {
    Map<String, String> preferences =
        ((MealsUser) SecurityContextHolder.getContext().getAuthentication().getPrincipal())
            .getPreferences();
    Products products =
        krogerService.getProductsByTerm(term, preferences.get(KROGER_LOCATION_KEY), pageCount);
  ...
  @ResponseStatus(HttpStatus.OK)
  public void addProductToCart(@RequestParam String upc, @RequestParam int count)
      throws URISyntaxException, UnsupportedEncodingException {
  ...
  public void addProductToList(
      @RequestParam String upc, @RequestParam int count, @RequestParam String weekName)
      throws URISyntaxException, UnsupportedEncodingException {
