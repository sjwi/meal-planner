...
public class SqlQueryStore {
  ...
  public SqlQueryStore() throws FileNotFoundException {
    sqlQueries =
        (Map<String, String>) new Yaml().load(new FileReader(ResourceUtils.getFile(SQL_CLASSPATH)));
  }

  public String get(String key, Map<String, String> preferences) {
    String sort =
        preferences.get("pinFavorites").equals("1")
                || preferences.get("pinFavorites").equalsIgnoreCase("true")
