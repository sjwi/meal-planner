...
public class Meal {
    ...
    public Meal(int id, String name, int count, Date lastEaten, boolean favorite, String recipeUrl, 
            String notes, List<Ingredient> ingredients, Map<Integer,String> tags) {
        this.id = id;
        this.name = name;
        this.count = count;
